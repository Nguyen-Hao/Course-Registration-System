...
//	return dssv;
//}
//Node_GV* dang_nhap_Giaovien(string namefile)
//{
//	char Tk[20], Mk[20];
//	List_GV dsgv = Read_File_DSGV(namefile);
//	Node_GV* p = new Node_GV;
//	do
//	{
...
//	return p;
//}
//ListSV* dang_nhap_sinhvien(string namefile)
//{
//	char Tk[20], Mk[20];
...
////	else if (a == 1)
////	{
////		Node_GV* node = new Node_GV;
////		node = dang_nhap_Giaovien("DSGiaoVien.txt");
////	}
////	else if (a == 2)
////	{
